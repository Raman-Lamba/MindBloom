...
const EMBEDDING_CACHE_PATH = './embedding-cache.json';
const CHUNK_CACHE_PATH = './chunk-cache.json';
const TEXT_CACHE_PATH = './extracted-text.txt';
...
therapeutic approaches, and mental health support. You have access to a comprehensive psychology textbook. 
For any questions: 1. Analyze relevant textbook sections 2. Cite specific concepts 3. Provide actionable guidance 
4. Acknowledge limitations 5. Maintain contextual awareness of previous questions. Respond with academic rigor 
